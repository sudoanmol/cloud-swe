...
const messages = {
  ...
  INVALID_ATTACHMENTS: "The attachment list is invalid",
  INVALID_UPLOAD: "Upload exactly one file and no form fields",
  INVALID_IMAGE: "The image is corrupt or unsupported",
  IMAGE_VARIANT_TOO_LARGE: "The processed image exceeds 3 MiB",
  MODEL_IMAGE_UNSUPPORTED: "The selected model does not accept images",
  ATTACHMENT_BOUND: "An attachment already used by a message cannot be deleted",
  ATTACHMENT_CREATE_FAILED: "Could not create attachment",
  ATTACHMENT_INVALID: "Attachment metadata is invalid",
  ATTACHMENT_MESSAGE_TOO_LARGE: "Message attachments exceed 50 MiB",
  ATTACHMENT_NOT_AVAILABLE: "An attachment is not available",
  ATTACHMENT_NOT_FOUND: "Attachment not found",
  ATTACHMENT_QUOTA_EXCEEDED: "Stored attachment allowance exceeded",
  ATTACHMENT_STATE: "The attachment state changed",
  ATTACHMENT_TOO_LARGE: "The attachment exceeds 25 MiB",
  ATTACHMENT_OBJECT_INVALID: "A stored attachment is missing or corrupt",
  ATTACHMENT_REFERENCE_INVALID: "The saved attachment reference is invalid",
  ATTACHMENT_MATERIALIZATION_FAILED: "Could not restore an attachment into the workspace",
